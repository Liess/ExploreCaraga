...
<body class="wide">
    ...
    <div class="wrapper">
        ...
        <!-- REVOLUTION SLIDER -->
        <div id="slider"> <div id="rev_slider_88_1_wrapper" class="rev_slider_wrapper fullwidthbanner-container" data-alias="youtube-hero" style="margin:0px auto;background-color:transparent;padding:0px;margin-top:0px;margin-bottom:0px;">
				<!-- START REVOLUTION SLIDER 5.0.7 fullwidth mode -->
					<div id="rev_slider_88_1" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.0.7">
						<ul>	<!-- SLIDE  -->
							<li data-index="rs-270" data-transition="zoomout" data-slotamount="default"  data-easein="Power3.easeInOut" data-easeout="Power3.easeInOut" data-masterspeed="3000"  data-thumb="vendor/rs-plugin/examples/assets/images/youtubebg-100x50.jpg"  data-rotate="0"  data-saveperformance="off"  data-title="Intro" data-description="">
								<!-- MAIN IMAGE -->
								<img src="vendor/rs-plugin/examples/assets/images/caragabanner.jpg"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
								<!-- LAYERS -->
					...
					<!-- PARALLAX -->
		<section class="parallax p-t-200 p-b-200 background-overlay-dark" style="background-image:url(images/caragapic1.jpg);" data-stellar-background-ratio="0.5">
			<div class="container">
				<div class="text-light">
					<h1 class="text-medium m-b-5">Enjoy the nature</h1>
					<h3>CARAGA is one of the regions that have so many </br> breathtaking beaches, mountains, springs, and lot of  </br>tourist spot that you'll like.</h3>
				</div>
			</div>
		</section>
			<section class="parallax p-t-200 p-b-200 background-overlay-dark" style="background-image:url(images/caragapic2.jpg);" data-stellar-background-ratio="0.5">
			<div class="container">
				<div class="text-light right">
					<h1 class="text-medium m-b-5">Enjoy the culture</h1>
					<h3>CARAGA is rich with cultural groups. See the fun and </br> colorful way of life with us.</h3>
				</div>
			</div>
		</section>
			<section class="parallax p-t-200 p-b-200 background-overlay-dark" style="background-image:url(images/caragapic3.jpg);" data-stellar-background-ratio="0.5">
			<div class="container">
				<div class="text-light">
					<h1 class="text-medium m-b-5">Enjoy the foods</h1>
					<h3>CARAGA have filipino dishes on it's own  style</br> and delicacies to boast to.</h3>
				</div>
			</div>
		</section>
		<!-- END: PARALLAX -->
